...
const StatCard: Component<StatCardProps> = (props) => {
    return (
        <div class="transition-all duration-300 active:scale-95 hover:-translate-y-0.5 hover:shadow-xl bg-white p-6 rounded-2xl select-none shadow-sm border-2 border-gray-300 flex flex-col">
